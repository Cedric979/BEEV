...
gc = gspread.service_account(path_list[-3])#The json key has to be defined by a google account in google API platform accessible here 'https://console.developers.google.com/'
